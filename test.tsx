    ...
    <div className="flex flex-col-reverse md:flex-row flex-1 overflow-hidden relative pb-[60px] md:pb-0">
        ...
        <nav className="fixed md:static bottom-0 left-0 right-0 h-[60px] md:h-auto md:w-[72px] bg-white border-t md:border-t-0 md:border-r border-slate-200 flex flex-row md:flex-col items-center justify-around md:justify-start py-2 md:py-4 gap-2 shrink-0 z-40">
            <button
                ...
                className={`w-16 h-12 md:w-14 md:h-14 rounded-2xl flex flex-col items-center justify-center gap-0.5 transition-all duration-200 ${activeMenu === 'penugasan'
...
<<<<<<< fix
                className={`w-16 h-12 md:w-14 md:h-14 rounded-2xl flex flex-col items-center justify-center gap-0.5 transition-all duration-200 ${activeMenu === 'liveview'
                        ? 'bg-primary text-white shadow-lg shadow-primary/25'
                        : 'bg-transparent text-slate-500 hover:bg-slate-100 hover:text-slate-700'
                    }`}
=======
...
<<<<<<< fix
                    className={`w-16 h-12 md:w-14 md:h-14 rounded-2xl flex flex-col items-center justify-center gap-0.5 transition-all duration-200 ${activeMenu === 'akun'
                            ? 'bg-primary text-white shadow-lg shadow-primary/25'
                            : 'bg-transparent text-slate-500 hover:bg-slate-100 hover:text-slate-700'
                        }`}
=======
            ...
            <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-1.5">
                    {importResult.details.map((d, idx) => (
                        <div
                            key={idx}
                            className={`flex items-start gap-3 p-3 rounded-xl border text-sm ${d.status === 'success'
                                    ? 'bg-emerald-50/50 border-emerald-100'
                                    : 'bg-rose-50/50 border-rose-100'
                                }`}
                        >
                            <span className={`material-symbols-outlined text-[18px] mt-0.5 shrink-0 ${d.status === 'success' ? 'text-emerald-600' : 'text-rose-600'
                                }`}>
